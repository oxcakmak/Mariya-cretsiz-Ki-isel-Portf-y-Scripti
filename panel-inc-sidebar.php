<?php echo '<!-- Sidebar -->
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="'.BASE_URL.'panel">
        <div class="sidebar-brand-icon"><img src="'.PANEL_ASSETS_URL.'img/logo/logo2.png"></div>
    ...
    <li class="nav-item"><a class="nav-link" href="'.BASE_URL.'panel/counter"><i class="fas fa-fw fa-sort-numeric-down"></i><span>'.$lang['m_counter'].'</span></a></li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <img class="img-profile rounded-circle" src="'.PANEL_ASSETS_URL.'img/boy.png" style="max-width: 60px">
