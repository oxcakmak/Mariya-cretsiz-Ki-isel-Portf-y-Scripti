<?php
echo '<script src="'.PANEL_ASSETS_URL.'vendor/jquery/jquery.min.js"></script>
<script src="'.PANEL_ASSETS_URL.'vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="'.PANEL_ASSETS_URL.'vendor/jquery-easing/jquery.easing.min.js"></script>
<script src="'.PANEL_ASSETS_URL.'js/ruang-admin.min.js"></script>
