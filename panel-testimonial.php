					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="mtContent">'.$lang['t_content'].'</label>
                                        <textarea rows="3" class="form-control" id="mtContent" placeholder="'.$lang['t_content'].'" maxlength="250"></textarea>
                                    </div>
                                </div>
							</div>
						</div>
				...
				<table class="table align-items-center table-flush">
					...
					echo '
						<tr id="'.$testimonialRow['testimonial_hash'].'">
                            ...
                            <td>'.$testimonialRow['testimonial_content'].'</td>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
                    ...
                    <div class="col-md-12">
						<div class="form-group">
							<label for="metContent">'.$lang['t_content'].'</label>
							<textarea rows="3" class="form-control" id="metContent" placeholder="'.$lang['t_content'].'" maxlength="250"></textarea>
						</div>
					</div>
				</div>
...
$(".addTestimonial").click(function(e){
    ...
    formData.append("mtContent", $("#mtContent").val());
...
function editTestimonialItem(hash){
	...
	$("#metContent").val(tableRow.children[3].outerText);
...
$(".editTestimonial").click(function(e){
	...
	formData.append("mtContent", $("#metContent").val());
