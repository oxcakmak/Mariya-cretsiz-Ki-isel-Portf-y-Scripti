...
<div class="form-group"><input type="password" class="form-control" id="pass" placeholder="'.$lang['t_password'].'" value="admin"></div>
<!--
...
$(".actionLogin").click(function(e){
	...
	$.ajax({
		type: "POST",
		url: "'.POST_URL.'",
		data: {user:$("#user").val(), pass:$("#pass").val(), actionLogin:"actionLogin"},
